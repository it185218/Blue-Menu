...
{id:'rofimata', nav:'Ροφήματα', t:'ΡΟΦΗΜΑΤΑ | BEVERAGES', items:[
 {n:'Νες Καφέ / Nescafé', p:'5.00€', d:'Στιγμιαίος καφές, ζεστός, με ή χωρίς γάλα / Instant coffee, hot, with or without milk'},
 {n:'Νες Καφέ Φραπέ / Nescafé Frappé', p:'5.00€', d:'Ο κλασικός ελληνικός κρύος χτυπητός καφές με πλούσιο αφρό / The classic Greek iced shaken coffee with rich foam'},
 {n:'Ελληνικός Καφές / Greek Coffee', p:'4.00€', d:'Παραδοσιακός καφές ψημένος αργά στο μπρίκι / Traditional coffee slowly brewed in a briki'},
 {n:'Φίλτρου (Γαλλικός) / Filter Coffee', p:'4.50€', d:'Απαλός καφές φίλτρου / Smooth slow-brewed filter coffee'},
 {n:'Εσπρέσο / Espresso', p:'4.00€', d:'Εκλεκτό χαρμάνι σε μονή ή διπλή δόση / Fine espresso blend, single or double shot'},
 {n:'Φρέντο Εσπρέσο / Freddo Espresso', p:'5.00€', d:'Διπλός espresso χτυπημένος με πάγο / Double espresso shaken over ice'},
 {n:'Καπουτσίνο / Cappuccino', p:'5.00€', d:'Espresso με βελούδινο ζεστό αφρόγαλα / Espresso with velvety steamed milk foam'},
 {n:'Φρέντο Καπουτσίνο / Freddo Cappuccino', p:'5.50€', d:'Κρύος διπλός espresso με παγωμένο αφρόγαλα / Iced double espresso topped with chilled milk foam'},
 {n:'Σοκολάτα / Chocolate', p:'5.50€', d:'Πλούσια σοκολάτα, ζεστή ή παγωμένη / Rich chocolate, served hot or iced'},
 {n:'Κρύο Τσάι / Ice Tea 330ml', p:'5.00€', d:'Παγωμένο τσάι λεμόνι ή ροδάκινο / Iced tea, lemon or peach'},
 {n:'Κρύο Τσάι / Ice Tea 500ml', p:'6.00€', d:'Παγωμένο τσάι λεμόνι ή ροδάκινο / Iced tea, lemon or peach'}
]},
...
{id:'soft', nav:'Αναψυκτικά', t:'ΑΝΑΨΥΚΤΙΚΑ | REFRESHMENTS', note:'Κουτί / Can 330ml', items:[
 {n:'Κόκα Κόλα / Coca-Cola', p:'5.00€', d:'Κλασική, light ή zero / Classic, light or zero'},
 {n:'Πορτοκαλάδα / Orangeade', p:'5.00€', d:'Πορτοκαλάδα με ανθρακικό ή χωρίς / Sparkling or still orangeade'},
 {n:'Λεμονάδα / Lemonade', p:'5.00€', d:'Δροσιστική λεμονάδα / Refreshing lemonade'},
 {n:'Σπράιτ / Sprite', p:'5.00€', d:'Αναψυκτικό λεμόνι-λάιμ / Lemon-lime soda'},
 {n:'Σόδα / Soda', p:'5.00€', d:'Ανθρακούχο νερό / Sparkling soda water'},
 {n:'Μεταλλικό Νερό / Mineral Water 0.5L', p:'1.00€', d:'Φυσικό μεταλλικό νερό / Natural mineral water'},
 {n:'Μεταλλικό Νερό / Mineral Water 1.5L', p:'2.00€', d:'Φυσικό μεταλλικό νερό / Natural mineral water'}
]},
